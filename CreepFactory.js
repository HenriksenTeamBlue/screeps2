...
var CreepStarter = require('CreepStarter');
var CreepCarrier = require('CreepCarrier');

function CreepFactory(depositManager, resourceManager, populationManager) {
...
CreepFactory.prototype.load = function(creep) {
	...
	switch(role) {
		case 'CreepCarrier':
			loadedCreep = new CreepCarrier(creep, this.depositManager);
		break;
		case 'CreepStarter':
			loadedCreep = new CreepStarter(creep, this.resourceManager, this.depositManager);
		break;
		case 'CreepMiner':
